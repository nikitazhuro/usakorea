...
const howWeWorkList = [
  ...
  { count: '02', title: 'Подбор автомобиля, торг и покупка автомобиля на аукционе' },
  ...
  { count: '05', title: 'Отправление контейнераи доставка в Клайпеду' },
  { count: '06', title: 'Доставка в Беларусь, фото выгрузки, сообщаем вам' },
