...
const howWeWorkList = [
  ...
  { count: '04', title: 'Оплата авто, вывоз на стоянку, фотофиксация вашей покупки' },
  { count: '05', title: 'Бронь контейнера, получение букинга, загрузка авто' },
  { count: '06', title: 'Отправление контейнера и доставка в Клайпеду' },
  { count: '07', title: 'Доставка в Беларусь, фотофиксация, сообщаем вам' },
  { count: '08', title: 'Растаможка автомобиля самостоятельно или с нашей помощью' },
]
